...
export const mockDocuments = [
  ...
  },
  {
    ...
    sendDate: '2024-09-20',
    approvalDate: null,
    reviewDeadline: '2024-09-27',  // 5 días laborables - VENCIDO
    cost: 5400,
  ...
  // Documentos con alertas de tiempo para demostrar el sistema
  {
    id: 'DOC-029',
    code: 'B43ITT298-TPT-10-PFD-003',
    name: 'Diagrama de Flujo - Unidad de Hidrotratamiento',
    projectId: 'PROJ-001',
    discipline: DISCIPLINES.PROCESS,
    type: 'PFD',
    status: DOCUMENT_STATUS.REV,  // En revisión - pendiente de respuesta
    revision: 'C',
    currentRevision: 'C',
    responsible: 'Ing. María González',
    sendDate: '2024-10-15',
    approvalDate: null,
    reviewDeadline: '2024-10-22',  // 5 días laborables - Próximo a vencer
    cost: 3800,
    description: 'PFD de la unidad de hidrotratamiento de naftas',
    comments: 'Enviado para primera revisión del cliente',
    currentFiles: {
      pdf: { url: '/documents/B43ITT298-TPT-10-PFD-003-C.pdf', name: 'B43ITT298-TPT-10-PFD-003-C.pdf' },
      editable: { url: '/documents/B43ITT298-TPT-10-PFD-003-C.xlsx', name: 'B43ITT298-TPT-10-PFD-003-C.xlsx', type: 'xlsx' }
    },
    revisionHistory: [
      { 
        revision: 'C', 
        date: '2024-10-15', 
        status: DOCUMENT_STATUS.REV, 
        comments: 'Primera entrega al cliente', 
        reviewer: 'Ing. María González',
        cost: 3800,
        costBreakdown: { hours: 40, rate: 95, resource: 'Ing. María González' },
        outgoingTransmittal: { id: 'TRN-025', code: 'TRN-B43-2024-025', date: '2024-10-15' },
        files: {
          pdf: { url: '/documents/B43ITT298-TPT-10-PFD-003-C.pdf', name: 'B43ITT298-TPT-10-PFD-003-C.pdf' },
          editable: { url: '/documents/B43ITT298-TPT-10-PFD-003-C.xlsx', name: 'B43ITT298-TPT-10-PFD-003-C.xlsx', type: 'xlsx' }
        }
      ...
      { 
        ...
        date: '2024-10-10', 
        status: DOCUMENT_STATUS.ELB, 
        comments: 'Revisión interna completada', 
        reviewer: 'Líder de Procesos',
        cost: 950,
        costBreakdown: { hours: 10, rate: 95, resource: 'Ing. María González' }
      },
      { 
        revision: 'A', 
        date: '2024-10-05', 
        ...
        reviewer: 'Ing. María González',
        cost: 1900,
        costBreakdown: { hours: 20, rate: 95, resource: 'Ing. María González' }
      },
    ],
  },
  {
    id: 'DOC-030',
    code: 'B43ITT298-TPT-80-DS-004',
    name: 'Datasheet - Compresor K-301',
    projectId: 'PROJ-001',
    discipline: DISCIPLINES.MECHANICAL,
    type: 'DS',
    status: DOCUMENT_STATUS.APR,  // Aprobado - listo para Rev. 0
    revision: 'D',
    currentRevision: 'D',
    responsible: 'Ing. Ana Torres',
    sendDate: '2024-10-18',
    ...
    comments: 'Aprobado sin comentarios - Listo para Rev. 0',
    currentFiles: {
      pdf: { url: '/documents/B43ITT298-TPT-80-DS-004-D.pdf', name: 'B43ITT298-TPT-80-DS-004-D.pdf' },
      editable: { url: '/documents/B43ITT298-TPT-80-DS-004-D.xlsx', name: 'B43ITT298-TPT-80-DS-004-D.xlsx', type: 'xlsx' }
    },
    revisionHistory: [
      { 
        revision: 'D', 
        ...
        cost: 400,
        costBreakdown: { hours: 5, rate: 80, resource: 'Ing. Ana Torres' },
        outgoingTransmittal: { id: 'TRN-026', code: 'TRN-B43-2024-026', date: '2024-10-16' },
        incomingTransmittal: { id: 'TRN-027', code: 'TRN-B43-IN-2024-027', date: '2024-10-18', clientResponse: 'APR' },
        files: {
          pdf: { url: '/documents/B43ITT298-TPT-80-DS-004-D.pdf', name: 'B43ITT298-TPT-80-DS-004-D.pdf' },
          editable: { url: '/documents/B43ITT298-TPT-80-DS-004-D.xlsx', name: 'B43ITT298-TPT-80-DS-004-D.xlsx', type: 'xlsx' }
        }
      ...
      { 
        ...
        date: '2024-10-12', 
        status: DOCUMENT_STATUS.ACC, 
        comments: 'Ajustar especificaciones de presión', 
        reviewer: 'Fiscalizador PETROECUADOR',
        cost: 640,
        costBreakdown: { hours: 8, rate: 80, resource: 'Ing. Ana Torres' },
        outgoingTransmittal: { id: 'TRN-024', code: 'TRN-B43-2024-024', date: '2024-10-10' },
        incomingTransmittal: { id: 'TRN-025', code: 'TRN-B43-IN-2024-025', date: '2024-10-12', clientResponse: 'ACC' }
      },
      { 
        revision: 'B', 
        date: '2024-10-05', 
        ...
        reviewer: 'Líder de Mecánica',
        cost: 800,
        costBreakdown: { hours: 10, rate: 80, resource: 'Ing. Ana Torres' }
      },
      { 
        revision: 'A', 
        date: '2024-09-28', 
        ...
        reviewer: 'Ing. Ana Torres',
        cost: 1360,
        costBreakdown: { hours: 17, rate: 80, resource: 'Ing. Ana Torres' }
      },
    ],
  },
  {
    id: 'DOC-031',
    code: 'B43ITT298-TPT-60-CALC-005',
    name: 'Cálculo de Flujo de Diseño',
    projectId: 'PROJ-001',
    discipline: DISCIPLINES.INSTRUMENTATION,
    type: 'CALC',
    status: DOCUMENT_STATUS.CMN,  // Comentado - necesita incorporar comentarios
    revision: 'E',
    currentRevision: 'E',
    responsible: 'Ing. Roberto Sánchez',
    sendDate: '2024-10-20',
    approvalDate: null,
    reviewDeadline: '2024-10-27',  // 5 días laborables
    cost: 2800,
    description: 'Cálculo de flujo de diseño para válvulas de control',
    comments: 'Incorporar comentarios del cliente y reenviar Rev. F',
    currentFiles: {
      pdf: { url: '/documents/B43ITT298-TPT-60-CALC-005-E.pdf', name: 'B43ITT298-TPT-60-CALC-005-E.pdf' },
      editable: { url: '/documents/B43ITT298-TPT-60-CALC-005-E.xlsx', name: 'B43ITT298-TPT-60-CALC-005-E.xlsx', type: 'xlsx' }
    },
    revisionHistory: [
      { 
        revision: 'E', 
        ...
        status: DOCUMENT_STATUS.CMN, 
        comments: 'Comentarios incorporados - Listo para reenvío', 
        reviewer: 'Ing. Roberto Sánchez',
        cost: 450,
        costBreakdown: { hours: 6, rate: 75, resource: 'Ing. Roberto Sánchez' }
      },
      { 
        revision: 'D', 
        date: '2024-10-15', 
        status: DOCUMENT_STATUS.CMN, 
        comments: 'Revisar rangos de instrumentos', 
        reviewer: 'Fiscalizador PETROECUADOR',
        cost: 375,
        outgoingTransmittal: { id: 'TRN-028', code: 'TRN-B43-2024-028', date: '2024-10-13' },
        incomingTransmittal: { id: 'TRN-029', code: 'TRN-B43-IN-2024-029', date: '2024-10-15', clientResponse: 'CMN' }
      },
      { 
        revision: 'C', 
        date: '2024-10-08', 
        status: DOCUMENT_STATUS.ACC, 
        comments: 'Ajustar cálculos de presión', 
        reviewer: 'Fiscalizador PETROECUADOR',
        cost: 600,
        outgoingTransmittal: { id: 'TRN-026', code: 'TRN-B43-2024-026', date: '2024-10-06' },
        incomingTransmittal: { id: 'TRN-027', code: 'TRN-B43-IN-2024-027', date: '2024-10-08', clientResponse: 'ACC' }
      },
      { 
        revision: 'B', 
        date: '2024-10-01', 
        ...
        reviewer: 'Líder I&C',
        cost: 750,
        costBreakdown: { hours: 10, rate: 75, resource: 'Ing. Roberto Sánchez' }
      },
      { 
        revision: 'A', 
        date: '2024-09-25', 
        ...
        reviewer: 'Ing. Roberto Sánchez',
        cost: 1125,
        costBreakdown: { hours: 15, rate: 75, resource: 'Ing. Roberto Sánchez' }
      },
    ],
  },
  {
    id: 'DOC-016',
    code: 'RLL-MOD-2024-TPT-10-PFD-001',
    name: 'PFD - Unidad de Destilación Atmosférica',
    projectId: 'PROJ-001',
    discipline: DISCIPLINES.PROCESS,
    type: 'PFD',
    status: 'IFC',
  ...
  {
    id: 'DOC-018',
    code: 'CSH-FAC-2024-ZPF-30-085',
    name: 'Plano de Fundaciones - Separadores',
    projectId: 'PROJ-002',
    discipline: DISCIPLINES.CIVIL,
    type: 'DRAWING',
    status: 'ELB',
    ...
    approvalDate: null,
    cost: 1800,
    description: 'Planos de fundaciones para separadores',
    comments: 'En revisión interna',
  },
  {
    id: 'DOC-019',
    code: 'CSH-FAC-2024-TPT-50-053',
    name: 'Isométrico - Línea Principal de Producción',
    projectId: 'PROJ-002',
    discipline: DISCIPLINES.PIPING,
    type: 'DRAWING',
    status: 'CMN',
    revision: 'D',
    currentRevision: 'D',
    ...
    approvalDate: null,
    cost: 2100,
    description: 'Isométrico de línea principal',
    comments: 'Revisar diámetros de tubería',
  },
  {
    id: 'DOC-020',
    code: 'TBL-AMP-2023-TPT-80-DS-001',
    name: 'Datasheet - Tanque de Almacenamiento T-101',
    projectId: 'PROJ-003',
    discipline: DISCIPLINES.MECHANICAL,
    type: 'DS',
    status: 'IFC',
    ...
    cost: 2800,
    description: 'Hoja de datos de tanque de almacenamiento',
    comments: 'Aprobado para construcción',
  },
  {
    id: 'DOC-021',
    code: 'TBL-AMP-2023-TPT-60-CALC-001',
    name: 'Cálculo de Presión de Diseño',
    projectId: 'PROJ-003',
    discipline: DISCIPLINES.INSTRUMENTATION,
    type: 'CALC',
    ...
    cost: 1500,
    description: 'Cálculo de presión de diseño para válvulas',
    comments: 'Aprobado sin comentarios',
  },
  {
    id: 'DOC-022',
    code: 'PPA-OPT-2023-TPT-10-283',
    name: 'P&ID - Sistema de Separación',
    projectId: 'PROJ-004',
    discipline: DISCIPLINES.PROCESS,
    type: 'DRAWING',
    status: 'IFC',
    revision: '0',
    currentRevision: '0',
    responsible: 'Ing. Laura Vega',
    sendDate: '2023-10-15',
    approvalDate: '2023-10-30',
    cost: 3600,
    description: 'P&ID del sistema de separación',
    comments: 'Aprobado para construcción',
  },
  {
    id: 'DOC-023',
    code: 'OTR-MAN-2024-TPT-50-054',
    name: 'Detalle de Tubería - Línea Principal',
    projectId: 'PROJ-005',
    discipline: DISCIPLINES.PIPING,
    type: 'DRAWING',
    status: 'ELB',
    revision: 'A',
    currentRevision: 'A',
    responsible: 'Ing. Pedro Torres',
    sendDate: null,
    approvalDate: null,
    cost: 1900,
    description: 'Detalle de tubería para línea principal',
    comments: 'En elaboración',
  },
  {
    id: 'DOC-024',
    code: 'REM-NUE-2022-TPT-10-PFD-002',
    name: 'PFD - Unidad de Hidrotratamiento',
    projectId: 'PROJ-006',
    discipline: DISCIPLINES.PROCESS,
    type: 'PFD',
    status: 'IFC',
    ...
    cost: 4200,
    description: 'PFD de la unidad de hidrotratamiento',
    comments: 'Aprobado para construcción',
  },
  {
    id: 'DOC-025',
    code: 'CSA-F2-2024-ZPF-30-086',
    name: 'Plano de Fundaciones - Edificio de Control',
    projectId: 'PROJ-007',
    discipline: DISCIPLINES.CIVIL,
    type: 'DRAWING',
    ...
    cost: 1600,
    description: 'Planos de fundaciones para edificio de control',
    comments: 'En elaboración - proyecto en pausa',
  },
  {
    id: 'DOC-026',
    code: 'TMV-MOD-2023-TPT-70-316',
    name: 'Diagrama Unifilar - Tablero de Distribución',
    projectId: 'PROJ-008',
    discipline: DISCIPLINES.ELECTRICAL,
    type: 'DRAWING',
    ...
    cost: 2200,
    description: 'SLD del tablero de distribución',
    comments: 'Aprobado para construcción',
  },
  {
    id: 'DOC-027',
    code: 'PGN-EXP-2024-TPT-10-284',
    name: 'P&ID - Sistema de Procesamiento de Gas',
    projectId: 'PROJ-009',
    discipline: DISCIPLINES.PROCESS,
    type: 'DRAWING',
    status: 'CMN',
    ...
    approvalDate: null,
    cost: 3800,
    description: 'P&ID del sistema de procesamiento',
    comments: 'Revisar válvulas de control',
  },
  {
    id: 'DOC-028',
    code: 'CLI-REH-2022-TPT-80-DS-002',
    name: 'Datasheet - Bomba Centrífuga P-201',
    projectId: 'PROJ-010',
    discipline: DISCIPLINES.MECHANICAL,
    type: 'DS',
    status: 'IFC',
  ...
  return new Promise((resolve) => {
    setTimeout(() => {
      const newDoc = {
        ...
        projectId,
        ...documentData,
        // Respect incoming status/revision; default to ELB/A when not provided
        status: documentData?.status || DOCUMENT_STATUS.ELB,
        revision: documentData?.revision || 'A',
        currentRevision: documentData?.currentRevision || documentData?.revision || 'A',
        sendDate: null,
        approvalDate: null,
      };
