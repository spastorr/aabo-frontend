/**
 * useReportsData hook
 * Fetches and manages reports data for a project
 * @module features/projects/reports/hooks/useReportsData
 */

import { useState, useEffect } from 'react';

export const useReportsData = (projectId) => {
  ...
  const fetchReportsData = async () => {
    try {
      ...
      // Mock data directly in the hook to avoid import issues
      ...
      console.error('Error in useReportsData:', err);
    } finally {
      setLoading(false);
    }
  };
